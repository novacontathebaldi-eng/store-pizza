...
export const HeroSection: React.FC = () => {
    ...
    return (
        <section id="inicio" className="bg-brand-green-700 text-text-on-dark min-h-[calc(100vh-80px)] flex items-center justify-center py-20 px-4 relative overflow-hidden">
            ...
            <div className="container mx-auto text-center z-10">
                <div className="inline-block bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20 mb-6">
                    <p className="font-semibold text-sm flex items-center gap-2"><i className="fas fa-award text-brand-gold-600"></i> Tradição desde 1909</p>
                </div>
                ...
                <p className="text-lg md:text-xl font-medium text-brand-ivory-50/90 mb-8 max-w-2xl mx-auto">
                    A pizza nº 1 do Espírito Santo, com ingredientes frescos, massa artesanal e o carinho de sempre.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <button onClick={scrollToCardapio} className="bg-brand-gold-600 text-text-on-dark font-bold py-3 px-8 rounded-xl text-lg hover:bg-opacity-90 transition-all transform hover:scale-105">
                        <i className="fas fa-pizza-slice mr-2"></i> Ver Cardápio Completo
                    </button>
                    <a href="https://wa.me/5527996500341" target="_blank" rel="noopener noreferrer" className="bg-transparent border-2 border-brand-gold-600 text-brand-gold-600 font-bold py-3 px-8 rounded-xl text-lg hover:bg-brand-gold-600 hover:text-text-on-dark transition-all transform hover:scale-105">
                        <i className="fab fa-whatsapp mr-2"></i> Pedir no WhatsApp
                    </a>
                </div>
            </div>
        </section>
